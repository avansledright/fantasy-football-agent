...
# Create Coach Code ZIP file
data "archive_file" "coach_lambda_zip" {
  type        = "zip"
  source_dir  = "${path.module}/coach_lambda"
  output_path = "${path.module}/builds/coach_lambda-${local.lambda_code_hash}.zip"
}